...
cargo test -p idiolect-adapter-whisper --all-features whisper_reports_typed_error_for_invalid_fixture_model
cargo test -p idiolectd --all-features --test config_runtime idiolectd_run_rejects_missing_model_path
